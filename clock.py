...
def main():
    ...
    if command == 'help':
        ...
        output = run_timew_command(['day', ':color'] + args)
        print_result(output)

    elif command == 'week':
        output = run_timew_command(['week', ':color'] + args)
        print_result(output)

    elif command == 'month':
        output = run_timew_command(['month', ':color'] + args)
        print_result(output)

    elif command == 'year':
        output = run_timew_command(['year', ':color'] + args)
        print_result(output)
